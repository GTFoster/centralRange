...
Add environmental range to our existing data
```{r}
...
Investigative plotting of relationship between environmental range and centrality
...
localiCent_list <- parLapply(cl, site_indices, function(i) {
  ...
  sims <- simulate(nullsetup, nsim = 20)
  rndout <- list()
